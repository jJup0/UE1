...
\includegraphics[width=\plotwidth, height=\plotheight]{merge_plot_Rank-each-Element_1000000_2000000.png}\\
\includegraphics[width=\plotwidth, height=\plotheight]{merge_plot_Rank-each-Element_10000000_20000000.png}\\
\includegraphics[width=\plotwidth, height=\plotheight]{merge_plot_Rank-each-Element_100000000_200000000.png}\\
...
\\
$O(t \cdot log(n+m) + t \cdot \frac{n+m}{t}) = O(n + m + t \cdot log(n+m)) = T_{seq}(n,m)$
\\
\\
